          ...
          ? <Formik
            ...
            /* check Docs for more Methods */
              ...
              <form method='POST' onSubmit={handleSubmit}>
                {loginFlashMessage !== ''
                  ? <div className='error-signup' style={{ color: 'red', minHeight: '1.5em', textAlign: 'center' }}><i style={{ fontSize: '0.7em' }} className='bi bi-x-circle-fill' />{loginFlashMessage}</div>
                  : <div style={{ color: 'red', minHeight: '1.5em', textAlign: 'center' }} />}
                <br />
